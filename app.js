...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'data', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 28830423, "filename": "/multimedia.pak"}, {"start": 28830423, "audio": 0, "end": 28831447, "filename": "/data/data"}, {"start": 28831447, "audio": 0, "end": 28832471, "filename": "/data/data.bkp"}], "remote_package_size": 28832471, "package_uuid": "d4307c8f-2045-4fa5-acb1-b57d00fba233"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 1716192,
    DYNAMIC_BASE = 6959072,
    DYNAMICTOP_PTR = 1715264;
...
var ASM_CONSTS = {
  461770: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 ...
 500291: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 501280: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 501373: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 502598: function() {return screen.width;},  
 502625: function() {return screen.height;},  
 502653: function() {return window.innerWidth;},  
 502685: function() {return window.innerHeight;},  
 502763: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 502897: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 503063: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 503289: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 503772: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=1716176;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 1715424;
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 1715328, 4), 1715328);function _gmtime_r(time, tmPtr) {
