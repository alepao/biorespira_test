...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'data', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 33081902, "filename": "/multimedia.pak"}, {"start": 33081902, "audio": 0, "end": 33082926, "filename": "/data/data"}, {"start": 33082926, "audio": 0, "end": 33083950, "filename": "/data/data.bkp"}], "remote_package_size": 33083950, "package_uuid": "db9e740a-d0a0-498f-8f76-4fe71ebfc1e0"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 1724640,
    DYNAMIC_BASE = 6967520,
    DYNAMICTOP_PTR = 1723712;
...
var ASM_CONSTS = {
 ...
 508976: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 509069: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 510294: function() {return screen.width;},  
 510321: function() {return screen.height;},  
 510349: function() {return window.innerWidth;},  
 510381: function() {return window.innerHeight;},  
 510459: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 510593: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 510759: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 510985: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 511468: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=1724624;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 1723872;
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 1723776, 4), 1723776);function _gmtime_r(time, tmPtr) {
